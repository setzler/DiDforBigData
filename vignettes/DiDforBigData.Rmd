...
Note: this plot automatically adjusts the levels in the theory-consistent way to account for changes in the pre-period composition of treated and control units across event times. This is necessary because cohort weights change across event times, which affects the composition of the levels.
