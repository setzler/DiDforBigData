...
A related issue is allowing for the individual-year errors to have different variances for different individuals. We implement the equivalent of the ", robust" option from Stata using the option `robust=TRUE`.
